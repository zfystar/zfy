        ...
        adjust: function() {
            for (var i = t(".gallery"), o = 0; o < i.length; o++) {
                ...
                f.each(function() {
                    ...
                    t(this).hasClass("w2") && a > 800 && 1 != n && t(this).css("width", 2 * c + h),
                    t(this).hasClass("full") && (t(this).css("width", d - h),
                    "auto" != e && t(this).css("height", s))
                })
                for (var v = f.length, m = Math.floor(v / n), p = v - m * n ? v - m * n : n, o = 0; v - p > o; o++)
                    t(f[o]).css("margin-bottom", h)
                for (var o = v - p; v > o; o++)
                    t(f[o]).css("margin-bottom", 0)
                r.isotope({
                    itemSelector: ".entry",
                    masonry: {
                        columnWidth: c + h
...
!function(n) {
    "use strict"
    function i() {
        n(".hero").css("height", .7 * u)
    }
    function e(i) {
        i === !0 ? n("#site-nav, #main-overlay").addClass("nav-open") : (n("#site-nav, #main-overlay").removeClass("nav-open"),
        setTimeout(function() {
            n("#menu li.has-submenu a").next(".submenu").slideUp(300)
        }, 500))
        i === !0 ? n("body").addClass("fixed-scrolling") : n("body").removeClass("fixed-scrolling")
    }
    function o() {
        ...
        s.on("scroll", function() {
            n(".reveal").each(function(i) {
                var e = n(this).offset().top
                  , o = u + s.scrollTop()
                o > e && n(this).delay(100 * i).queue(function() {
    ...
    n("#menu li:has(ul)").find("a").on("click", function() {
        var i = n(this).parent()
          , e = n(this).next("ul")
        return e.is(":visible") && n(this).parent().find("ul").slideUp(300),
        e.is(":hidden") && (i.siblings().find("ul").slideUp(300),
